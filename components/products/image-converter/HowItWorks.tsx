...
const steps = [
    {
        ...
        description: "Drag and drop single images or whole batches. Supports PNG, JPG, JPEG, WEBP, AVIF, GIF, BMP, TIFF, and more.",
    ...
    },
    {
        ...
        description: "Pick your target format, set compression quality, and optionally resize. All processing happens locally in your browser.",
    ...
    },
    {
        ...
        description: "Download files one by one or grab all converted images in a single ZIP — ready to use straight away.",
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-lg text-slate-600 leading-relaxed">
                        Convert any image format in three steps — no account, no upload, no wait.
                    </p>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        <div
                            className="hidden md:block absolute top-20 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-500 via-blue-500 to-green-500 opacity-20"
