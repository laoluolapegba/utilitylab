...
const included = [
    "Unlimited conversions — fully client-side, no server needed",
    "20+ formats: PNG, JPG, WEBP, AVIF, GIF, BMP, TIFF, ICO, and more",
    "Batch conversion with ZIP download",
    "Quality control and resize on convert",
    "Upgrade for priority support and advanced features",
];
        ...
        <section className="py-20 lg:py-28 bg-slate-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
                ...
                <p className="text-slate-500 max-w-xl mx-auto mb-10 text-base leading-relaxed">
                    Image Converter is part of the UtilityLab suite — one subscription unlocks every tool.
                    Because conversion is fully client-side, the free tier has no daily cap.
                </p>
